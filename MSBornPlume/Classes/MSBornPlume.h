...
@property (nonatomic, readonly) BOOL iPeached;          ///< 调用了暂停, 暂停播放
@property (nonatomic, readonly) BOOL iPluming;         ///< 调用了播放, 处于播放中
...
@property (nonatomic, readonly) BOOL iPlumed;                                      ///< 当前的资源是否调用过`play`
...
@property (nonatomic, readonly) BOOL iFurry;                              ///< 是否已全屏
